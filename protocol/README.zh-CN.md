...
**展示包 0.2.12** 与 **PF3 Handoff v0.1 draft** 是不同的版本。[v0.2.2 审计记录](../docs/contract-audit-v0.2.2.md)对应八项约定的测试证据与限定范围的反例核验；[v0.2.3 对照验证](../docs/contract-audit-v0.2.3.md)补充 frozen 独立返回值的合法实现；[v0.2.4 工程记录](../docs/engineering-v0.2.4.md)说明 CI 矩阵、Schema/示例与清单校验。行为约定、参考实现语义与 Schema 均保持不变。
