...
[中文](README.md) · [Run the example](#run-the-example) · [Handoff protocol](protocol/README.md#english-contract-summary) · [Work with Elara](COLLABORATE.md#working-with-elara)
...
- [Handoff protocol v0.1 draft](protocol/README.md#english-contract-summary): read, write, version checks, receipts and conflict recovery.
- [JSON Schema](protocol/handoff.schema.json) and [example messages](protocol/examples/handoff.json): concrete payload shapes.
...
**This is a minimal handoff contract, not the complete PF3 MCP API or a compatibility certification.** Passing the suite covers only the specified behavior. Full product integration and use in a real business workflow require further evaluation.
