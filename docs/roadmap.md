...
0.2.x 只接文档修订。v0.2.6 用合成项目串起设计说明，并展开续接包的五个问题，沿用 v0.2.3 的契约语义与 v0.2.4 的工程检查；合作沟通继续开放。详见[工程记录](engineering-v0.2.4.md)与[合作流程](../COLLABORATE.md)。
